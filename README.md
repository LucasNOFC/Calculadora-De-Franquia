...
**Importante**: A aplicação não possui integração com a API da FIPE e SGA.

## Como rodar na minha máquina ?

Para rodar a aplicação localmente:
  Será necessário ter o [Git](https://git-scm.com/install/windows) baixado em sua máquina.
  Após a instalação, seguir com as instruções abaixo:
...
## Quem usa a solução?
  O colaborador que realiza os processos de acionamento, e precisa passar para o associado a informação relacionada a franquia.

  A solução acelera a entrega das informações para os associados, de modo que se ganha tempo e evita erros de cálculos.

## Como acesso essa aplicação?
  A aplicação está disponível em produção no link: [Calculadora de Franquia](https://lucasnofc.github.io/Calculadora-De-Franquia/)

 
## Qual a arquitetura da aplicação?
  A aplicação segue uma aplicação simples utilizando HTML5, JS e Tailwind, suficiente para fins didáticos e demonstrativos.
